...
set f0 [open newdelay.tr w]
set f1 [open newthroughput.tr w]
set f2 [open newpacketloss.tr w]
...
proc record {} {
  global sink37 sink38 sink39 sink23 sink40 sink5 sink6 sink7 f0 f1 f2
   ...
   set time 0.05
   set bw0 [$sink39 set nlost_]
   set bw1 [$sink40 set nlost_]
   set now [$ns now]
   puts $f0 "$now [expr $bw0]"
   puts $f1 "$now [expr $bw1]"
    puts $f2 "$now [expr $bw1*2]"
...
$node_(14) set X_ 123.0
$node_(14) set Y_ 364.0
$node_(14) set Z_ 0.0
# Generation of movements
$node_(0) color yellow
$ns at 4.7 "$node_(0) color yellow"

$node_(10) color yellow
$ns at 4.72 "$node_(10) color yellow"

$node_(6) color yellow
$ns at 4.74 "$node_(6) color yellow"

$node_(4) color yellow
$ns at 4.76 "$node_(4) color yellow"

$node_(7) color yellow
$ns at 4.78 "$node_(7) color yellow"
#
$node_(0) color black
$ns at 4.8 "$node_(0) color black"

$node_(10) color black
$ns at 4.8 "$node_(10) color black"

$node_(6) color black
$ns at 4.8 "$node_(6) color black"

$node_(4) color black
$ns at 4.8 "$node_(4) color black"

$node_(7) color black
$ns at 4.8 "$node_(7) color black"
##
$node_(0) color yellow
$ns at 4.82 "$node_(0) color yellow"

$node_(14) color yellow
$ns at 4.84 "$node_(14) color yellow"

$node_(9) color yellow
$ns at 4.86 "$node_(9) color yellow"

$node_(7) color yellow
$ns at 4.88 "$node_(7) color yellow"
#
#################################################################################################################################
$ns at 0.0 "$node_(0) label SOURCE"
$ns at 0.0 "$node_(7) label DESTINATION"

$ns at 2.8 "$node_(5) label NODE-ISOLATED"
$ns at 2.8 "$node_(11) label NODE-ISOLATED"
######
...
$ns at 2.8 "$node_(11) add-mark . orange square"
$ns at 2.8 "$node_(5) add-mark . orange square"

$ns at 0.5 "$node_(0) label FAKE-RREQ+fake_dest_add"
$ns at 0.7 "$node_(0) label SOURCE"

$ns at 0.7 "$node_(10) label FAKE-RREQ+fake_dest_add"
$ns at 0.9 "$node_(10) label ."

$ns at 0.7 "$node_(5) label FAKE-RREQ+fake_dest_add"
$ns at 0.9 "$node_(5) label ."

$ns at 0.9 "$node_(14) label FAKE-RREQ+fake_dest_add"
$ns at 1.1 "$node_(14) label ."

$ns at 1.1 "$node_(6) label FAKE-RREQ+fake_dest_add"
$ns at 1.3 "$node_(6) label ."

$ns at 1.3 "$node_(9) label FAKE-RREQ+fake_dest_add"
$ns at 1.5 "$node_(9) label ."

$ns at 1.5 "$node_(4) label FAKE-RREQ+fake_dest_add"
$ns at 1.8 "$node_(4) label ."

$node_(11) color red
$ns at 2.0 "$node_(11) color red"

$ns at 2.0 "$node_(11) label FAKE-RREP+ID"
$ns at 2.2 "$node_(11) label BLACK-HOLE-NODE"

$node_(5) color red
$ns at 2.0 "$node_(5) color red"

$ns at 2.0 "$node_(5) label FAKE-RREP+ID"
$ns at 2.2 "$node_(5) label BLACK-HOLE-NODE"

$ns at 2.2 "$node_(10) label FAKE-RREP+ID"
$ns at 2.4 "$node_(10) label ."
###
$ns at 2.9 "$node_(0) label RREQ"
$ns at 3.1 "$node_(0) label ."

$ns at 3.1 "$node_(10) label RREQ"
$ns at 3.3 "$node_(10) label ."

$ns at 3.3 "$node_(14) label RREQ"
$ns at 3.5 "$node_(14) label ."

$ns at 3.5 "$node_(9) label RREQ"
$ns at 3.7 "$node_(9) label ."

$ns at 3.7 "$node_(4) label RREQ"
$ns at 3.9 "$node_(4) label ."
#
$ns at 2.5 "$node_(10) label ALARM-MESSAGE"
$ns at 2.8 "$node_(10) label ."

$ns at 2.5 "$node_(6) label ALARM-MESSAGE"
$ns at 2.8 "$node_(6) label ."

$ns at 2.5 "$node_(12) label ALARM-MESSAGE"
$ns at 2.8 "$node_(12) label ."

$ns at 2.5 "$node_(4) label ALARM-MESSAGE"
$ns at 2.8 "$node_(4) label ."

$ns at 2.5 "$node_(2) label ALARM-MESSAGE"
$ns at 2.8 "$node_(2) label ."

$ns at 2.5 "$node_(14) label ALARM-MESSAGE"
$ns at 2.8 "$node_(14) label ."

$ns at 2.5 "$node_(9) label ALARM-MESSAGE"
$ns at 2.8 "$node_(9) label ."

$ns at 2.5 "$node_(7) label ALARM-MESSAGE"
$ns at 2.8 "$node_(7) label DESTINATION"

$ns at 2.5 "$node_(3) label ALARM-MESSAGE"
$ns at 2.8 "$node_(3) label ."

$ns at 2.5 "$node_(13) label ALARM-MESSAGE"
$ns at 2.8 "$node_(13) label ."

$ns at 2.5 "$node_(8) label ALARM-MESSAGE"
$ns at 2.8 "$node_(8) label ."

$ns at 2.5 "$node_(1) label ALARM-MESSAGE"
$ns at 2.8 "$node_(1) label ."

############
$ns at 4.0 "$node_(7) label RREP"
$ns at 4.2 "$node_(7) label ."

$ns at 4.2 "$node_(9) label RREP"
$ns at 4.4 "$node_(9) label ."

$ns at 4.2 "$node_(6) label RREP"
$ns at 4.4 "$node_(6) label ."

$ns at 4.4 "$node_(14) label RREP"
$ns at 4.6 "$node_(14) label ."

$ns at 4.4 "$node_(10) label RREP"
$ns at 4.6 "$node_(10) label ."

$ns at 5.0 "$node_(7) label DESTINATION"
$ns at 5.0 "$node_(0) label SOURCE"
...
###################################################################################################################################
# Set a TCP connection between nodes
set tcp [new Agent/TCP/Newreno]
set sink [new Agent/TCPSink]
...
$ns at $val(stop) "stop"
$ns at 14.0 "puts \"end simulation\" ; $ns halt"
proc stop {} {
